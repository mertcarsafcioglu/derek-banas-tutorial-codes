...
public class JavaLesson30 extends JFrame{
	...
	, sexLabel, optionsLabel, aboutLabel;
	...
	public JavaLesson30() {
		...
		addComp(thePanel, statePanel, 0, 2, 5, 1, GridBagConstraints.EAST, GridBagConstraints.NONE);
		...
		addComp(thePanel, optionBox, 0, 3, 2, 1, GridBagConstraints.NORTHWEST,GridBagConstraints.NONE );
		...
		JScrollPane scroolbar1= new JScrollPane(aboutYou,JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
		
		addComp(thePanel, scroolbar1, 2, 3, 3, 1, GridBagConstraints.EAST,GridBagConstraints.NONE );
	...
	private void addComp(JPanel thePanel, JComponent comp,
			int xPos, int yPos, int compWidth, int compHeight, int place,
			int stretch) {
